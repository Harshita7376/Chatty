...
import com.example.project.model.StatusModel;
...
public class StatusAdapter extends RecyclerView.Adapter <StatusAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //set on long press event on every status and delete the status
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                AlertDialog.Builder alert=new AlertDialog.Builder(context);
                alert.setTitle("Configration");
                alert.setMessage("Do you want to delete our Status");
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        {
                            Toast.makeText(context, "Don't try delete.This is not your Status", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
